...
class PaywallState extends State<Paywall> {
        ...
        child: Container(
          ...
          decoration: isReq
              ? BoxDecoration(
                  ...
                  color: uiNotifier.materialThemeData.colorScheme.primary
                      .withOpacity(0.4),
  ...
  buildPurchaseCardInside(ProductUIDesc uiDesc, bool isReq) {
    ...
    TextStyle tStyle = const TextStyle(fontSize: 10);
    ...
    widgets.add(Text(uiDesc.title, textAlign: TextAlign.center));
    widgets.add(Text(uiDesc.priceString, textAlign: TextAlign.center));
